...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remote_save_target_password,
            commands::remote_delete_target_password,
            commands::remote_has_target_password,
            commands::remote_trust_target_host,
            commands::remote_get_host_key_fingerprints,
